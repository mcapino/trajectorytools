...
public class Point {
    final int time;
    final tt.jointeuclidean2ni.Point positions;

    public Point(tt.euclid2i.Point[] positions, int time) {
        this.positions = new tt.jointeuclidean2ni.Point(positions);
        this.time = time;
    }

    public Point(tt.jointeuclidean2ni.Point positions, int time) {
    ...
    public tt.jointeuclidean2ni.Point getPositions() {
        return positions;
    }
