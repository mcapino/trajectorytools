...
public class EuclideanLevyRRTStar<S, E> extends RRTStar<S, E> {

    protected Set<S> kdKeys;
    protected KDTree<Vertex<S, E>> kdTree;
    protected EuclideanCoordinatesProvider<S> euclideanProvider;

    public EuclideanLevyRRTStar(Domain<S, E> domain, EuclideanCoordinatesProvider<S> euclideanProvider,
    ...
    protected Collection<Vertex<S, E>> getVerticesInRadius(S state, double radius) {
        double[] key = euclideanProvider.getEuclideanCoordinates(state);
        try {
