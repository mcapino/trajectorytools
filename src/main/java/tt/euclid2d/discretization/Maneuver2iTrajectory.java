...
public class Maneuver2iTrajectory<V extends SpatialPoint, E extends SpatialManeuver> implements EvaluatedTrajectory {
    ...
    public Maneuver2iTrajectory(double startTime, GraphPath<V,E> graphPath, double duration) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Maneuver2iTrajectory){
            Maneuver2iTrajectory other = (Maneuver2iTrajectory) obj;
