 ...
 * @since Apr 16, 2012
 */
public final class AStarShortestPathSimple<V, E>
{
     ...
     */
    public AStarShortestPathSimple(Graph<V, E> graph, V startVertex,
    ...
    {
        AStarShortestPathSimple<V, E> alg =
            new AStarShortestPathSimple<V, E>(
                graph,
                startVertex,
                endVertex,
                heuristic);
