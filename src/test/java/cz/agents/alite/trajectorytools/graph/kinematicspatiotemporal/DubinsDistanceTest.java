...
public class DubinsDistanceTest {
	...
	@Test
	public void test() {
		KinematicStraightLineDomain domain = new KinematicStraightLineDomain(new Box4dRegion(new Point4d(0,0,0,0), new Point4d(10,10,10,10)), new OrientedTimePoint(0,0,0,0,0,1,0), new ArrayList<SpaceTimeRegion>(), new SpatialPoint(20,20,5), 10, 15, 15, 15, 10, 50, 45, new Random(1));
