...
public abstract class AbstractLValueIntegratorTest {

    private static final double PRECISION = 0.01;

    protected LValueIntegrator integrator;
    protected List<Complex> testPath;

    abstract LValueIntegrator initializeIntegrator(List<Complex> qRoots, List<Complex> pRoots);
